...
const Activity01 = {
        ...
        name: "Activity01",
        // AppComponent: App,
        routerPath: "Part07/Activity01/indexRouter.js",

        components: {

            [App_Name]: {
            name: App_Name,
            path: "Part07/Activity01/App.vue",
            resetCode: App
            },

          "indexRouter.js": {
            name: "indexRouter.js",
            path: "Part07/Activity01/indexRouter.js",
            resetCode: indexRouter
          },

            "default.vue": {
            name: "default.vue",
            path: "Part07/Activity01/default.vue",
            resetCode: default_
            },

            "Message.vue": {
            name: "Message.vue",
            path: "Part07/Activity01/Message.vue",
            resetCode: Message
            },

            "MessageEditor.vue": {
            name: "MessageEditor.vue",
            path: "Part07/Activity01/MessageEditor.vue",
            resetCode: MessageEditor
            },

            "messageLayout.vue": {
            name: "messageLayout.vue",
            path: "Part07/Activity01/messageLayout.vue",
            resetCode: messageLayout
            },

            "MessageList.vue": {
            name: "MessageList.vue",
            path: "Part07/Activity01/MessageList.vue",
            resetCode: MessageList
            },

            "Messages.vue": {
            name: "Messages.vue",
            path: "Part07/Activity01/Messages.vue",
            resetCode: Messages
            },
