...
"import TheWelcome from '@/components/ExerciseStrings/Part07/Exercise05/TheWelcome.vue'\n" +
"</script>\n" +
"\n" +
"<template>\n" +
"  <main>\n" +
...
const Exercise05 = {
        ...
        name: "Exercise05",
        // AppComponent: App,
        routerPath: "Part07/Exercise05/indexRouter.js",
        components: {

          "App.vue": {
            name: "App.vue",
            path: "Part07/Exercise05/App.vue",
            resetCode: App
          },

          "indexRouter.js": {
            name: "indexRouter.js",
            path: "Part07/Exercise05/index.js",
            resetCode: index
          },

          "Error.vue": {
            name: "Error.vue",
            path: "Part07/Exercise05/Error.vue",
            resetCode: Error
          },

            "AboutView.vue": {
            name: "AboutView.vue",
            path: "Part07/Exercise05/AboutView.vue",
            resetCode: AboutView
            },

          "Message.vue": {
            name: "Message.vue",
            path: "Part07/Exercise05/Message.vue",
            resetCode: Message
          },

          "MessageAuthor.vue": {
            name: "MessageAuthor.vue",
            path: "Part07/Exercise05/MessageAuthor.vue",
            resetCode: MessageAuthor
          },

          "MessageFeed.vue": {
            name: "MessageFeed.vue",
            path: "Part07/Exercise05/MessageFeed.vue",
            resetCode: MessageFeed
          },

          "MessageInfo.vue": {
            name: "MessageInfo.vue",
            path: "Part07/Exercise05/MessageInfo.vue",
            resetCode: MessageInfo
          },

          "messages.js": {
            name: "messages.js",
            path: "Part07/Exercise05/messages.js",
            resetCode: messages
          },

          "TheWelcome.vue": {
            name: "TheWelcome.vue",
            path: "Part07/Exercise05/TheWelcome.vue",
            resetCode: TheWelcome
          },

          "WelcomeItem.vue": {
            name: "WelcomeItem.vue",
            path: "Part07/Exercise05/WelcomeItem.vue",
            resetCode: WelcomeItem
          },

            "HomeView.vue": {
            name: "HomeView.vue",
            path: "Part07/Exercise05/HomeView.vue",
            resetCode: HomeView
            },

            "IconCommunity.vue": {
            name: "IconCommunity.vue",
            path: "Part07/Exercise05/IconCommunity.vue",
            resetCode: IconCommunity
            },

            "IconDocumentation.vue": {
            name: "IconDocumentation.vue",
            path: "Part07/Exercise05/IconDocumentation.vue",
            resetCode: IconDocumentation
            },

            "IconEcosystem.vue": {
            name: "IconEcosystem.vue",
            path: "Part07/Exercise05/IconEcosystem.vue",
            resetCode: IconEcosystem
            },

            "IconSupport.vue": {
            name: "IconSupport.vue",
            path: "Part07/Exercise05/IconSupport.vue",
            resetCode: IconSupport
            },

            "IconTooling.vue": {
            name: "IconTooling.vue",
            path: "Part07/Exercise05/IconTooling.vue",
