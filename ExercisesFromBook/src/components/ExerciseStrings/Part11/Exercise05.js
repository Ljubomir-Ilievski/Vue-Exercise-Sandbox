...
const Exercise05 = {
        ...
        name: "Exercise05",
        // AppComponent: App,
        routerPath: "Part11/Exercise05/indexRouter.js",

        components: {

            "App.vue": {
            name: "App.vue",
            path: "Part11/Exercise05/App.vue",
            resetCode: App
            },

            "CookieBanner.vue": {
            name: "CookieBanner.vue",
            path: "Part11/Exercise05/CookieBanner.vue",
            resetCode: CookieBanner
            },

            "HelloWorld.vue": {
            name: "HelloWorld.vue",
            path: "Part11/Exercise05/HelloWorld.vue",
            ...
            "indexRouter.js": {
            name: "indexRouter.js",
            path: "Part11/Exercise05/indexRouter.js",
            resetCode: index
            },

            "NewsletterBanner.vue": {
            name: "NewsletterBanner.vue",
            path: "Part11/Exercise05/NewsletterBanner.vue",
            resetCode: NewsletterBanner
            },

            "PostList.vue": {
            name: "PostList.vue",
            path: "Part11/Exercise05/PostList.vue",
            resetCode: PostList
            },

            "PostListItem.vue": {
            name: "PostListItem.vue",
            path: "Part11/Exercise05/PostListItem.vue",
            resetCode: PostListItem
            },

            "SinglePost.vue": {
            name: "SinglePost.vue",
            path: "Part11/Exercise05/SinglePost.vue",
            resetCode: SinglePost
            },

            "store.js": {
            name: "store.js",
            path: "Part11/Exercise05/store.js",
            resetCode: store
            },

            "TagPage.vue": {
            name: "TagPage.vue",
            path: "Part11/Exercise05/TagPage.vue",
            resetCode: TagPage
            },
